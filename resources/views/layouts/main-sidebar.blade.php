				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						@can('الفواتير الغير مدفوعة')	
							<li><a class="slide-item" href="{{ url('/' . $page='partialPaid_invoices') }}">الفواتير المدفوعة جزئيا</a></li>
						@endcan	
						@can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='archived_invoices') }}">الأرشيف</a></li>
						@endcan
						</ul>
					</li>
