...
@endif
		...
		<div class="modal" id="archive_invoice">
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-demo">
					<div class="modal-header">
						<h6 class="modal-title">الغاء أرشفة الفاتورة</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
					</div>
					<div class="modal-body">
						<h6>هل أنت متأكد من الغاء الأرشفة</h6>
                        
					</div>
					<div class="modal-footer">
                            <a class="btn ripple btn-success archive-invoice-btn" href="">ازالة من الأرشيف</a>
                            <button class="btn ripple btn-secondary" data-dismiss="modal" type="button">الغاء</button>
...
<script>
    ...
    $("a.archive_invoice").click(function () {
        $('.archive-invoice-btn').attr('href',  "{{url('/restore_invoice')}}/" + $(this).data('invoice_id') );
    })
</script>
